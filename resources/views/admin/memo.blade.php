...
<body>
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <button class="btn btn-success"><a href="{{route('admin.add-memo')}}" style="text-decoration: none; color: #878790;">+ Add Memo </a></button>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Status Approve -->
                        @if ($i % 3 != 0 && $i % 2 != 0) 
                            <button class="btn btn-sm4"><img src="/img/memo-admin/arsip.png" alt="arsip"></button>
                        @else
                            <button class="btn btn-sm3"><img src="/img/memo-admin/edit.png" alt="edit"></button>
                        @endif
                    </td>
                </tr>
                @endfor
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body text-center">
                ...
                <button type="button" class="btn-cancel" data-bs-dismiss="modal"><a href="{{route ('admin.memo')}}">Cancel</a></button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body text-center">
                ...
                <!-- Tombol -->
                <button type="button" class="btn-back" data-bs-dismiss="modal"><a href="{{route ('admin.memo')}}">Back</a></button>
            </div>
            </div>
        </div>
        </div>
